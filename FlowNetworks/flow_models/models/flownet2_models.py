...
class FlowNet2(nn.Module):
    ...
    def forward(self, x1, x2):
        ...
        flownetc_flow = self.upsample1(flownetc_flow2[0]*self.div_flow)
        ...
        flownets1_flow = self.upsample2(flownets1_flow2[0]*self.div_flow)
        ...
        flownets2_flow = self.upsample4(flownets2_flow2[0] * self.div_flow)
        ...
        flownetsd_flow = self.upsample3(flownetsd_flow2[0] / self.div_flow)
